...
const translations = {
  UA: {
    ...
    metrics: "Метрики",
    buckets: "Кошики",
    select_a_bucket: "Виберіть кошик",
    select_buckets_to_see_charts: "Виберіть кошик для перегляду графіків.",
    bucket_interactive: "Кошик - Інтерактивний",
    ...
    search_buckets: "Пошук кошиків",
    add_bucket: "Додати кошик",
    loading: "Завантаження",
    you_have_no_buckets_created:
      "У вас немає створених кошиків. Додайте один, щоб почати роботу.",
    size: "Розмір",
    objects: "Об'єкти",
    create_a_bucket: "Створити кошик",
    maximum_bucket_name: "Максимальна довжина назви кошика - 63 символи.",
    invalid_bucket_name: "Невірна назва кошика.",
    bucket_with_name_exists: "Кошик з такою назвою вже існує.",
    get_started_by_creating_new_bucket:
      "Почніть роботу, створивши новий порожній кошик. Ви зможете додавати дані до кошик через панель керування.",
    bucket_name: "Назва кошика",
    bucket_name_is_permanent: "Назва кошика є постійною та незмінною.",
    location: "Розташування",
    default: "За замовчуванням",
    we_have_chosen:
      "Ми обрали Східну Європу для розміщення вашого кошика. Вкажіть інше розташування, якщо потрібно.",
    versioning: "Версійність",
    not_versioned_bucket: "Кошика без версійності",
    only_one_version:
    ...
    by_default_buckets_are_not_publicly_accessible:
      "За замовчуванням кошики не є публічно доступними. Ви можете отримати доступ до об'єктів у кошику, прив'язавши кошик до Worker або використовуючи API. Доступ до кошика можна змінити на публічний у будь-який момент.",
    cancel: "Скасувати",
    create: "Створити",
    ...
    delete_bucket: "Видалити кошик",
    delete: "Видалити",
    to_delete_this_bucket: "Щоб видалити цей кошик, введіть",
    object: "Об'єкт",
    folder: "Папка",
    refresh: "Оновити",
    upload: "Завантажити",
    ...
    created_at: "Створено",
    versions: "Версії",
    your_bucket_is_ready: "Ваш кошик готовий. Додайте файли, щоб розпочати.",
    drag_and_drop_files_here: "Перетягніть файли сюди для завантаження або",
    select_from_your_computer: "виберіть з комп’ютера",
    continue_file_selection: "Продовжити вибір файлів",
    close: "Закрити",
    remove: "Видалити",
    custom_upload_path: "Власний шлях завантаження",
    file_selected: " файл(ів) вибрано",
  },
  EN: {
    welcome_message:
    ...
    versions: "Versions",
    your_bucket_is_ready: "Your bucket is ready. Add files to get started.",
    drag_and_drop_files_here: "Drag and drop your files here to upload or",
    select_from_your_computer: "select from your computer",
    continue_file_selection: "Continue file selection",
    close: "Close",
    remove: "Remove",
